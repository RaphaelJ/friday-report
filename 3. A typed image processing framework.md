...
Masked images are images for which not every pixels are defined. They are used
when you want to ignore some areas of an image. For example, you want to ignore
an image's background when applying transformations.
